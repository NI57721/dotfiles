...
set linked_files .vimrc .vimrc.ime .vim/vsnip/ruby.json .vim/rc/dein{,_lazy}.toml .config/fish/{config.fish,fish_plugins}  .gitignore_global .tmux.conf .bashrc .config/paru/paru.conf .config/waybar/{config,style.css,scripts/ppp.sh} .config/wezterm/wezterm.lua
