...
set linked_files .vimrc .vimrc.ime .vim/vsnip/ruby.json .vim/rc/dein.toml .vim/rc/dein_lazy.toml .config/fish/config.fish .config/fish/fish_plugins .gitignore_global .tmux.conf .bashrc .config/paru/paru.conf .config/waybar/config .config/waybar/style.css .config/waybar/scripts/ppp.sh .config/wezterm/wezterm.lua
