...
set linked_files .vimrc .vim/vsnip/ruby.json .vim/rc/dein.toml .vim/rc/dein_lazy.toml .config/fish/config.fish .config/fish/config.fish.local .config/fish/fish_plugins .gitignore_global .tmux.conf .bashrc .bashrc.local .config/fcitx5/config .config/fcitx5/profile .config/fcitx5/conf/skk.conf
