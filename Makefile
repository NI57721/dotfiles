...
PACKAGES := base-devel bat curl git git-delta github-cli hyperfine ntfs-3g openssh pinta python3 python-pip ripgrep the_silver_searcher tmux tree unzip wget xclip xfce4
